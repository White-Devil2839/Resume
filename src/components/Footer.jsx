// If file is named ThemeToggleButton.jsx in the same folder
import ThemeToggleButton from './ThemeToggleButton';


export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-white text-black dark:bg-[#0e111a] dark:text-gray-400 py-10 px-6 border-t border-green-600 mt-20 transition-colors duration-300">
      {/* Subtle glow orbs */}
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
        <div className="text-center md:text-left">
          <p>
            Made with ❤️ by <span className="text-green-400">Divyansh Choudhary</span>
          </p>
